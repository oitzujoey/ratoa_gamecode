...
void SP_target_start_timer (gentity_t *ent);
void SP_target_stop_timer (gentity_t *ent);
...
//Standard Domination point spawn:
	...
	{"target_startTimer", SP_target_start_timer},
	{"target_stopTimer", SP_target_stop_timer},
